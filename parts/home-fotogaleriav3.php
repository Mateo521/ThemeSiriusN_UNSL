            ...
            ?>
                ...
                ?>
                  ...
                  <div class="swiper-slide" style="background-color: #0b2439;">
                    ...
                    <div style="background-image: url('<?php echo esc_url($image_url); ?>');position:absolute;width:100%;height:100%;left:0;bottom:0;background-position:center;background-size:contain;z-index:-1;background-repeat:no-repeat;  <?php if ($i == $max_count - 1) {
